...
import BookStore.Discount1;
import BookStore.Discount2;
import BookStore.Discount3;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to online BookStore, please enter your book's price, name, author, type and number in this type 'price, name, author, type, number'");
